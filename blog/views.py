...
def create_blog(request):
    if request.method == 'POST':
        ...
        if blog is None:
            ...
            return render(request, 'blog/create_blog.html', {'error_message': message, 'title': 'Create Blog'})
    return render(request, 'blog/create_blog.html', {'title': 'Create Blog'})
...
def login_page(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, 'blog/login.html', {'error_message': message, 'title': 'Login'})
    else:
...
def register_page(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'blog/register.html', {'error_message': message, 'title': 'Register'})
...
def create_post(request, blog_id):
    if request.method == 'POST':
        ...
        if author == request.user:
            try:
                ...
                return render(request, 'blog/create_post.html', {'error_message': message, 'title': 'Create Post'})
    ...
    return render(request, 'blog/create_post.html', {'title': 'Create Post'})
...
def edit_post(request, blog_id, post_id):
    ...
    if request.method == 'POST':
        ...
        if existing_post != post:
            message = "Post with the same title already in this blog."
            return render(request, 'blog/edit_post.html', {'error_message': message, 'title': 'Edit Post'})
